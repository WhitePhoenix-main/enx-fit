Promise.all([
    fetch("/marko/header.html").then(res => res.text()),
    fetch("/marko/footer.html").then(res => res.text()),
    fetch("/marko/sidebar.html").then(res => res.text()),
    fetch("/marko/search-form.html").then(res => res.text())
  ])
  ...
  function initBannerVideo() {
    $('.banner-video-container').addClass('external-video-disabled');
}
